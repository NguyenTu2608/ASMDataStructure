...
import static StudentManagement.Student.bubbleSortByMark;
import static StudentManagement.Student.quickSortById;
...
public class Main {
    public static void main(String[] args) {
        ...
        st.addStudent(students, new Student("BH001","Nguyen Anh Tu", 8.0));
        st.addStudent(students, new Student("BH002","Nguyen Anh Tuan", 7.5));
        st.addStudent(students, new Student("BH003","Nguyen Anh Toan", 6.0));
        st.addStudent(students, new Student("1","Nguyen Thanh Tung", 1));
        ...
        edit.editStudentByPosition(students, 6, new Student("BH009", "Teo", 4));
        System.out.println("********* List data of students after updated by Position **********");
        for (Student s : students){
            System.out.println("ID = " + s.id +" , fullName = " + s.fullName + " , mark = " + s.mark + " , rank = " + s.rank);
        }
        ...
        Sort.bubbleSortByMark(students);
        ...
        Sort.quickSortById(students, 0, students.size() - 1);
        for (Student str : students){
            System.out.println(str);
        }
